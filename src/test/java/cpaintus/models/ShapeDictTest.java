...
class ShapeDictTest {
	...
	@Test
	void addShapeTest() {
		Shape actual = shapeFactory.getShape(ShapeType.RECTANGLE, true, 0, new Point(0, 11), new Point(0, 0), 1, 10, 100, 1, "#fff", "#fff",
				"", "hh");
	...
	void clearShapesTest() {
		shapeDict.addShape(shapeFactory.getShape(ShapeType.RECTANGLE, true, 0, new Point(0, 11), new Point(0, 0), 1, 10, 100, 1, "#fff",
				"#fff", "", "hh"));
		shapeDict.clearShapes();
	...
	void addShapes() {
		shapeDict.clearShapes();
		shapeDict.addShape(shapeFactory.getShape(ShapeType.RECTANGLE, true, 3, new Point(6, 11),new Point(0,0), 200, 10, 0, 1, "#ff1ff",
				"#fff56", "", "test"));
		shapeDict.addShape(shapeFactory.getShape(ShapeType.ELLIPSE, true, 5, new Point(7, 11), new Point(0,0), 220, 100, 30, 2, "#fff98",
				"#ff678", "", "test"));
		shapeDict.addShape(shapeFactory.getShape(ShapeType.HEART, true, 3, new Point(22, 11), new Point(0,0), 320, 130, 100, 6, "#fff45",
				"#f678f", "", "test"));
		shapeDict.addShape(shapeFactory.getShape(ShapeType.HEART, true, 3, new Point(22, 11), new Point(0,0), 320, 130, 100, 6, "#fff45",
				"#f678f", "", "test"));
