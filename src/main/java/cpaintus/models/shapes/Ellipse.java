...
public class Ellipse extends Shape2D {
	...
	public Ellipse(ShapeType shapeType, String shapeId, int canvasHash, Point position, int z, double rotation,
	...
	public Ellipse makeCopy() {
		return new Ellipse(this.getShapeType(), this.getShapeId(), this.getCanvasHash(),
